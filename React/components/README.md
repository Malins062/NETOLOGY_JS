...
1. [Страница интернет-магазина (функциональный компонент)](react-store-func/README.md).
1. [Страница интернет-магазина (class-based компонент)](react-store-class/README.md).
1. [Календарь](react-calendar/README.md) — необязательная задача со звёздочкой.
