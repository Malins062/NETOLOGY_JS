...
1. [Страница интернет-магазина (функциональный компонент)](store-func/README.md).
1. [Страница интернет-магазина (class-based компонент)](store-class/README.md).
1. [Календарь](calendar/README.md) — необязательная задача со звёздочкой.
