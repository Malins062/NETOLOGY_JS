...
[![Build status](https://ci.appveyor.com/api/projects/status/ofburp279kp3we25/branch/main?svg=true)](https://ci.appveyor.com/project/Malins062/ahjs-game-goblin/branch/main)

!['Фото игры гоблин'](./pic/GracefulMiniatureBustard-small.gif)
